package zw.co.bigtech.erp.repository;

import zw.co.bigtech.erp.ErpApp;
import zw.co.bigtech.erp.config.Constants;
import zw.co.bigtech.erp.config.audit.AuditEventConverter;
import zw.co.bigtech.erp.domain.PersistentAuditEvent;
...
import static zw.co.bigtech.erp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
