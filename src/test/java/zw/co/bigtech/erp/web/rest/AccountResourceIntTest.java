package zw.co.bigtech.erp.web.rest;

import zw.co.bigtech.erp.config.Constants;
import zw.co.bigtech.erp.ErpApp;
import zw.co.bigtech.erp.domain.Authority;
import zw.co.bigtech.erp.domain.PersistentToken;
import zw.co.bigtech.erp.domain.User;
import zw.co.bigtech.erp.repository.AuthorityRepository;
import zw.co.bigtech.erp.repository.PersistentTokenRepository;
import zw.co.bigtech.erp.repository.UserRepository;
import zw.co.bigtech.erp.security.AuthoritiesConstants;
import zw.co.bigtech.erp.service.MailService;
import zw.co.bigtech.erp.service.dto.UserDTO;
import zw.co.bigtech.erp.web.rest.errors.ExceptionTranslator;
import zw.co.bigtech.erp.web.rest.vm.KeyAndPasswordVM;
import zw.co.bigtech.erp.web.rest.vm.ManagedUserVM;
import zw.co.bigtech.erp.service.UserService;
